...
const appImages = {
  ...
  OneB: require('../../../assets/images/OneB.jpg'),
  // TwoB: require('../../../assets/images/TwoB.png'),
  ThreeB: require('../../../assets/images/ThreeB.jpg'),
  FourB: require('../../../assets/images/FourB.jpg'),
  FiveB: require('../../../assets/images/FiveB.jpg'),
  oops: require('../../../assets/images/oops.png'),
};

const appIcons = {
  Brainlogo: require('../../../assets/icons/Brainlogo.png'),
};
